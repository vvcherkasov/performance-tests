...
from clients.grpc.gateway.users.client import UsersGatewayGRPCClient, build_users_gateway_locust_rpc_client
from clients.grpc.gateway.accounts.client import build_accounts_gateway_locust_rpc_client, AccountsGatewayGRPCClient
from clients.grpc.gateway.cards.client import build_cards_gateway_locust_rpc_client, CardsGatewayGRPCClient
from clients.grpc.gateway.operations.client import build_operations_gateway_locust_rpc_client, \
    OperationsGatewayGRPCClient
from clients.grpc.gateway.documents.client import build_documents_gateway_locust_rpc_client, DocumentsGatewayGRPCClient
...
class GatewayGrpcTaskSet(TaskSet):
    ...
    def on_start(self) -> None:
        ...
        """
        self.users_gateway_client = build_users_gateway_locust_rpc_client(self.user.environment)
        self.cards_gateway_client = build_cards_gateway_locust_rpc_client(self.user.environment)
        self.accounts_gateway_client = build_accounts_gateway_locust_rpc_client(self.user.environment)
        self.operations_gateway_client = build_operations_gateway_locust_rpc_client(self.user.environment)
        self.documents_gateway_client = build_documents_gateway_locust_rpc_client(self.user.environment)
